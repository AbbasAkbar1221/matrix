...
const NumberGrid = () => {
  const highlightedNumbers = new Set([
    1, 12, 23, 34, 45, 56, 67, 78, 89, 100, 109, 118, 127, 136, 145, 154, 163,
    172, 181, 192, 203, 214, 225,
  ]);

  const initialRedNumbers = [
    9, 20, 29, 38, 47, 56, 65, 74, 83, 92, 101, 112, 123, 134, 145, 156, 167,
    178, 189, 200, 209, 218, 227,
  ];
  const [redNumbers, setRedNumbers] = useState(new Set(initialRedNumbers));

  const [directions, setDirections] = useState(
    initialRedNumbers.map(() => "left")
  );
    ...
    <div className="flex justify-center bg-gray-300">
      <div className="grid grid-cols-10 grid-rows-23 p-4 w-fit h-fit ">
        {Array.from({ length: 230 }).map((_, index) => (
          <div
            key={index}
            className={`h-20 w-20 bg-black text-white flex items-center justify-center border
